...
### 4. Сборка
Для теста наивного варианта раскомментировать следующую строку (может занимать от нескольких до 10-20 минут):
```csharp
// MultiplyNaive(matrixA, matrixB, result, N);
```
## Результаты работы
Ниже представлен скриншот консоли с результатами замеров времени и MFlops для каждого варианта.
...
namespace MatrixMultiplicationLab
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            // Раскомментировать строку ниже для теста наивного варианта 
            // MultiplyNaive(matrixA, matrixB, result, N); 
            sw.Stop();
